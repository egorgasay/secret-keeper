...
var file_api_proto_server_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x45, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x52,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xd0, 0x01, 0x0a, 0x0c, 0x53, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x4b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x04, 0x41, 0x75,
...
var file_api_proto_server_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_api_proto_server_proto_depIdxs = []int32{
	4, // 0: api.SecretKeeper.Auth:input_type -> api.AuthRequest
	6, // 1: api.SecretKeeper.Register:input_type -> api.RegisterRequest
	0, // 2: api.SecretKeeper.Get:input_type -> api.GetRequest
	2, // 3: api.SecretKeeper.Set:input_type -> api.SetRequest
	5, // 4: api.SecretKeeper.Auth:output_type -> api.AuthResponse
	7, // 5: api.SecretKeeper.Register:output_type -> api.RegisterResponse
	1, // 6: api.SecretKeeper.Get:output_type -> api.GetResponse
	3, // 7: api.SecretKeeper.Set:output_type -> api.SetResponse
